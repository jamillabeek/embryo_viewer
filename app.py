                ...
                dcc.Tab(label='Welcome', value='tab-0', children=[
                    html.Div([
                        html.Div([
                            ...
                            html.P("Note that the viewer includes a large amount of data. Accordingly, when viewing the full dataset it may take up to a few minutes to load. Please, wait for the viewer to finish loading before interacting, and be a bit patient when switching tabs or making a lot of changes."),
                            html.P("For more information or any issues with the viewer, please contact us via a.alemany [at] lumc.nl."),
                            ], style={
